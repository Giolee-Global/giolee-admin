                ...
                <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-md-5 text-end">
                            <a href="edit-admin?id=<?php echo $adminID; ?>" class="button btn btn-dark"><i class="bi bi-pen"></i> Edit Account</a>
                            <button type="button" data-id="<? echo $adminID; ?>" onclick="confirmAdminDelete(this);" class="button btn btn-danger"><i class="bi bi-trash"></i> Delete Account</button>
                        </div>
                    </div>
                </main>
            </div>
