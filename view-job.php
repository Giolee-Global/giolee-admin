                ...
                <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-md-8 text-end">
                            <a href="edit-job?id=<?php echo $jobID; ?>" class="button btn btn-dark"><i class="bi bi-pen"></i> Edit Job</a>
                            <button type="button" data-id="<? echo $jobID; ?>" onclick="confirmJobDelete(this);" class="button btn btn-danger"><i class="bi bi-trash"></i> Delete Job</button>
                        </div>
                    </div>
