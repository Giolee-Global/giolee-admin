                ...
                <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                    ...
                    <div class="mb-6 mb-xl-10">
                        <div class="row g-3 align-items-center">
                            <div class="col">
                                <h3 class="ls-tight">Oil Spill Response, Onshore & Offshore</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
                        <div class="row align-items-center mb-10" style="display: none;">
                            ...
                            <div class="col-md-8 col-xl-5">
                                <div class="">
                                    <input type="number" value="<?php echo $adminID; ?>" name="adminID" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mb-10">
                            ...
                            <div class="col-md-8 col-xl-5">
                                <div class="">
                                    <textarea type="text" rows="16" name="lastName" id="oilSpillResponse" class="form-control"><?php echo $lastName; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row align-items-center mb-10">
