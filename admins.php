                                        ...
                                        <div class="table-responsive mb-10 mt-5">
                                            <table id="admins" class="table table-hover table-striped table-sm table-nowrap">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $admin_id = 1;
                                                    $select_query = "SELECT * FROM admin ORDER BY dateCreated ASC";
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <a href="view-admin?id=<?php echo $adminID; ?>" class='btn btn-dark btn-sm'><i class="bi bi-eye"></i></a>
                                                                    <button type="button" data-id="<? echo $adminID; ?>" onclick="confirmAdminDelete(this);" class='btn btn-danger btn-sm'><i class="bi bi-trash"></i></button>
